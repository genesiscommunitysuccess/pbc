...
export const metadata: AppMetadata = {
  ...
  dependencies: {
    ...
    '@genesislcap/foundation-alerts': '14.127.6-pbc-demo.3',
    '@genesislcap/foundation-inbox': '14.127.6-pbc-demo.3',
    '@genesislcap/foundation-notifications': '14.127.6-pbc-demo.3',
